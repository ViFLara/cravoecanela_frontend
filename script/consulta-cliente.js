    ...
    if(tbody){
        tbody.innerHTML = listaCliente.cliente.map( cliente => {
            return `<tr>
                ...
                <td class="botao"><button onclick="perguntaConfirmaExclusao( ${cliente.id})" type="button"><img title="Excluir" src="images/lixeira-de-reciclagem.png" alt="Botão para excluir cliente"></button>
                </td>
            </tr>`
        }).join('')
    }
